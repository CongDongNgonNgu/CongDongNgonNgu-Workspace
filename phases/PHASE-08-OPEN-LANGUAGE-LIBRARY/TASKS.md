...
Phase 08B1 implementation is published after owner visual acceptance. Contribution
forms, reviewer UI, imports, candidate consumption, moderation UI, and deployment
remain out of scope.
